...
{
    internal class GridHighlightProperties : NineSliceGump
    {
        ...
        private void Build()
        {
            ...
            targetContainerBtn.MouseUp += (s, e) =>
            {
                ...
                {
                    World.TargetManager.SetTargeting((GameObject targetedObj) =>
                    {
                        if (targetedObj != null && targetedObj is Entity targetedEntity)
                        {
                            if (SerialHelper.IsItem(targetedEntity.Serial))
                            {
            ...
            {
                AddProperty(data.Properties, i, pos.Y, new HashSet<string>[] { GridHighlightRules.Properties, GridHighlightRules.SuperSlayerProperties, GridHighlightRules.SlayerProperties });
                pos.Y += 25;
            }
            ...
            {
                AddOther(data.ExcludeNegatives, i, pos.Y, new HashSet<string>[] { GridHighlightRules.NegativeProperties, GridHighlightRules.Properties, GridHighlightRules.SuperSlayerProperties, GridHighlightRules.SlayerProperties });
                pos.Y += 25;
            }
            ...
            {
                AddOther(data.RequiredRarities, i, pos.Y, new HashSet<string>[] { GridHighlightRules.RarityProperties });
                pos.Y += 25;
            }
