...
{
    internal static class GridHighlightRules
    {
        ...
        public static void SaveGridHighlightConfiguration()
        {
            ...
            try
            {
                string json = JsonSerializer.Serialize(config, GridHighlightSettingsJsonContext.Default.GridHighlightSettings);
        ...
        public static void LoadGridHighlightConfiguration()
        {
            ...
            try
            {
                ...
                GridHighlightSettings config = JsonSerializer.Deserialize(json, GridHighlightSettingsJsonContext.Default.GridHighlightSettings);
        ...
        internal class GridHighlightSettings
        {
    ...
    // Source generator context for JSON serialization (avoids reflection)
    [System.Text.Json.Serialization.JsonSerializable(typeof(GridHighlightRules.GridHighlightSettings))]
    [System.Text.Json.Serialization.JsonSourceGenerationOptions(WriteIndented = true)]
    internal partial class GridHighlightSettingsJsonContext : System.Text.Json.Serialization.JsonSerializerContext
    {
    }
}
